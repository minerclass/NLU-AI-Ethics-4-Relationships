(() => {
  ...
  // Presenter notes are stripped out of the published deck and kept in a
  // private file outside this folder, so the notes UI is absent here. The
  // engine is otherwise unchanged from diss-proposal-defense/presentation.
  const hasNotes = Boolean(notesDrawer && notesButton && notesContent);
